                    ...
                    <div class="col-md-8">
                     <div class="form-group row">
                       ...
                       <div class="col-sm-2 mt-2">
                        <input type="text" name="aadhar_number" id="aadhar_number" class="form-control form-control-sm" placeholder="Enter No" >
                       </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7 mt-2">
                      <input type="text" name="account_name" id="account_number" class="form-control form-control-sm" placeholder="Ac Number">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="form-group row">
                       ...
                       <input type="text" name="account_name" id="account_name" class=" form-control form-control-sm" placeholder="Enter Name">
                      </div>
                    </div>
                  </div>
                </div>
