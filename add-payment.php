    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row"> 
            <div class="col-md-12">
              <h2 class="">Payment voucher</h2>
              <div class="d-flex">
                <i class="mdi mdi-home text-muted hover-cursor"></i>
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Dashboard&nbsp;/&nbsp;</p>
                <p class="text-primary mb-0 hover-cursor">payment voucher</p>
              </div>
            </div>
          </div>
           <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                   <form class="form-sample" action="payment-insert.php" method="POST" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8 ">
                             <input type="date" value="" name="dop" class="form-control form-control-sm"  placeholder="dd/mm/yyyy">
                          </div>
                        </div>
                      </div> 
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label text-right">Cash/Bank</label>
                          <div class="col-sm-8 ">
                           <select name="bank" class="form-control form-control-sm" name="brand" id="brand">
                              <option>SBI</option>
                              <option>HDFC</option>
                             </select>
                          </div>
                      ...
                      <div class="col-md-5">
                       <div class="form-group row">
                      <label class="col-sm-4 col-form-label ">Vocher/Ref No</label>
                      <div class="col-sm-4">
                      ...
                      <thead>
                       ...
                       <tbody>
                        ...
                        <td class="small-td"><input type="text" name="amount[]" class="form-control form-control-sm"></td>
                         <td class="large-td"><select name="description[]" class="form-control form-control-sm" name="" id="">
