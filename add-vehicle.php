...
$result = mysqli_query($connection,"SELECT * FROM vehicle_brand_edition");
?>
<html lang="en">
                ...
                <div class="card-body">
                   <form class="form-sample" action="addvehicle.php" method="POST" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        <div class="form-group row">
                         <label class="col-sm-3 col-form-label text-right" id="hello">Vehicle Brand</label>
                        ...
                        ?>
                            ...
                            ?>
                              <option><?php echo $row["vehiclebrandedition"]; ?></option>
                             <?php
                            $i++;
                            }
                            ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label text-right" id="hello">Vehicle Class</label>
                          <div class="col-sm-9 mt-2">
                            <input type="text" name="class" id="class" class="form-control form-control-sm" placeholder=" Enter Vehicle Class">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-3"></div>
