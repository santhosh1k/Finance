                      ...
                      <div class="form-group row">
                         <label class="col-sm-5 col-form-label text-right" id="hello">Date</label>
                          <div class="col-sm-7 mt-2">
                            <input type="text" id="account_name" class="form-control form-control-sm" placeholder="dd/mm/yyyy">
                          </div>
                      </div>
                    </div>
                    <div class="col-md-8">
                     <div class="form-group row">
                       ...
                       <div class="col-sm-2 mt-2">
                        <input type="text" id="aadhar_number" class="form-control form-control-sm" placeholder="Enter No" >
                       </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7 mt-2">
                      <input type="text" id="accno" class="form-control form-control-sm" placeholder="Ac Number">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7 mt-2">
                      <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Payment">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8">
                   ...
                   <div class="col-md-4">
                      <div class="form-group row">
                       <label class="col-sm-5 col-form-label text-right" id="hello">Line Colle Date</label>
                        <div class="col-sm-7 mt-2">
                        <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Line Colle Date">
                        </div>
                      </div>
                    </div>
                   <div class="col-md-8">
                      <div class="form-group row">
                         ...
                         <div class="col-sm-2 mt-2">
                         <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Book No">
                         </div>
                          <div class="col-sm-3 mt-2">
                         <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Book No">
                         </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group row">
                          ...
                          <div class="col-sm-7 mt-2">
                          <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Existing No">
                          </div>
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="form-group row">
                         ...
                         <div class="col-sm-5 mt-2">
                         <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Revised No">
                         </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" style="margin-bottom: -1.5rem;">
                      <div class="col-md-5">
                         <div class="form-group row">
                           ...
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Name">
                           </div>
                         </div>
                      </div>
                      <div class="col-md-6">
                       ...
                       <div class="col-sm-6 mt-2">
                      <input type="date" id="aadhar_number" class="form-control form-control-sm" placeholder="dd/mm/yyyy" >
                          </div>
                        </div>
                      </div>
                      </div>
                    ...
                    <div class="row" id="linespace">
                      <div class="col-md-5">
                       <div class="form-group row">
                           ...
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Code">
                           </div>
                       ...
                       <div class="col-md-6">
                         <div class="form-group row">
                          ...
                          <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Due Date">
                           </div>
                         </div>
                      </div>
                      <!-- <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="col-md-5">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-8 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Vehicle No">
                           </div>
                         </div>
                      </div>
                      <div class="col-md-6">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-6 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Dp1 due">
                           </div>
                         </div>
                      </div>
                    <!--  <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="col-md-5">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-8 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Model">
                           </div>
                         </div>
                      </div>
                       <div class="col-md-6">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-6 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Dp2 due">
                           </div>
                         </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-5">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-8 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Dp1">
                           </div>
                         </div>
                      </div>
                      <div class="col-md-6">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-6 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="EMI Due">
                           </div>
                         </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-5">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-8 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Dp2">
                           </div>
                         </div>
                      </div>
                      <div class="col-md-6">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-6 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Amount">
                           </div>
                         </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-5">
                         <div class="form-group row">
                           ...
                           <div class="col-sm-8 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Finance Amount">
                           </div>
                         </div>
                      </div>
                      <!--<div class="col-md-5">
                    ...
                    <div class="row">
                      <div class="col-md-5">
                         <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right" id="hello">Total</label>
                           <div class="col-sm-8 mt-2">
                           <input type="text" id="account_name" class="form-control form-control-sm" placeholder="Total">
                           </div>
                         </div>
                      </div>
                    </div>
...
//     var url = "borrowerreceipt2.php?param=";
